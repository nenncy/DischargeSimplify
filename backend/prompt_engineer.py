...
def build_simplify_prompt(text: str) -> str:
    ...
    return (
        ...
        "Simplify the following discharge instructions text into clear, patient-friendly language at approximately a 6th-grade reading level.\n\n"
        ...
        "  \"Summary\": a single cohesive paragraph (5–7 sentences) that includes all essential details, especially diagnosis and reason for discharge.\n"        
